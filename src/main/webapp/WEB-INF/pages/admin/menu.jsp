...
<div class="col-md-2">
    <ul class="nav nav-pills nav-stacked" id="nav">
        ...
        <li><a href="/admin/shensuList">申诉查看<span class="badge pull-right"></span></a></li>
        <li><a href="/admin/gonggao">发布公告<span class="badge pull-right"></span></a></li>
        ...
        <li><a onclick="logoutConfirmd()">退出系统
