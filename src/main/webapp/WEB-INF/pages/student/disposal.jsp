                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-default btn-xs btn-danger btn-primary" data-toggle="modal"
                                        data-target="#exampleModal" data-whatever="${item.id}">申诉
                                </button>
                                <!--弹出框-->
                            </td>
                        </tr>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <div class="form-group">
                                        <label for="content" class="control-label">请输入申诉内容:</label>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" onclick="shensu()">申诉</button>
                            </div>
                        </div>
                    </div>
                </div>
